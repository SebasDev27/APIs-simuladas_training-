...
const listaProductos = document.getElementById('product-list'); // Lista de productos
const id = document.getElementById('id'); // Campo de ID
const nombreProducto = document.getElementById('nombre'); // Campo de nombre
const categoriaProducto = document.getElementById('categoria'); // Campo de categoría
const precioProducto = document.getElementById('precio'); // Campo de precio
const cantidadProducto = document.getElementById('cantidad'); // Campo de cantidad
